...
def main(
    ...
    out_file = glue_save_location + "original.json"
    ...
    #####################################################
        ...
        start = time()
        #do initial GLUE EVAL WITH EDITED MODEL
        glue_results = {'edit_num': -1}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name",
        choices=["microsoft/phi-1_5", "google/gemma-7b-it", "meta-llama/Llama-3.1-8B", "gpt2-medium", "gpt2-large", "gpt2-xl", "EleutherAI/gpt-j-6B", "NousResearch/Llama-2-13b-hf", "NousResearch/Llama-2-7b-hf", "facebook/opt-13b", "tiiuae/falcon-7b", "mistralai/Mistral-7B-v0.1", "deepseek-ai/deepseek-llm-7b-base", "Qwen/Qwen2.5-7B"],
        default="gpt2-xl",
        help="Model to edit.",
        required=True,
    )
