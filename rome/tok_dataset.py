...
def flatten_masked_batch(data, mask):
    ...
    # list all tokens without paddings
    # for a data with [3,345,6400] ([#entries, #tokens, #features])
    # flat_data gives [3\times345,6400]
    # mask has [3,345]
    # mask.view(-1) gives [3\times345]
    # mask.view(-1).nonzero() gives [3\times345,1] nonzeros always give 2d vector
    # flat_data[attended_tokens] gives feature vectors of all nonzero tokens
